...
Future<void> main() async {
  await Supabase.initialize(
    ...
    anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpqdHlhenprcXF5dHN4Z3Vta3ZjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDA1NTIzODUsImV4cCI6MjAxNjEyODM4NX0.lEpVcFEe8MJ7IwvO4BaZe2j5m-61Z-Z_3Zy7RrggIi8',
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/view/home': (context) => HomePage(), // Add route for the home page
      },
    );
  }
}